...
\begin{enumerate}[leftmargin=1em, itemsep=0.01em, labelsep=0.2em, topsep=0em]
  ...
  {\small \textbf{Стек:} Java, Kotlin, Spring Boot, Gradle, PostgreSQL, Kafka, SOAP, Docker} 
  {\small
    \vspace{-0.5mm}
  ...
  {\small \textbf{Стек:} React, TypeScript, RTK Query, SCSS, Styled Components, Java, Spring Cloud, Kotlin} 
  {\small
    \vspace{-0.5mm}
    \begin{itemize}[leftmargin=1.2em, itemsep=0.1em, topsep=0pt, partopsep=0pt]
