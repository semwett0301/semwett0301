...
- **[desktop-audio-compiler](https://github.com/semwett0301/desktop-audio-compiler)** - full-stack desktop audio player and LeadDesk audio compiler: desktop client for managing and playing audio files, with a Python FastAPI backend handling JWT-protected API endpoints and token validation. Tech stack: TypeScript, Python 3.11, FastAPI, Uvicorn, JWT, Docker, Docker Compose, CSS.
