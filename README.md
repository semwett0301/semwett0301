...
- **[ai-talent-hub-cifra](https://github.com/semwett0301/ai-talent-hub-cifra)** — AI intelligence hub that collects, deduplicates, and structures industry news for PR/GR teams, turning raw RSS/web sources into ranked, summarized clusters ready for media, regulators, and Telegram distribution. The system ingests sources through dedicated collectors, batches and clusters news via a RabbitMQ pipeline, ranks relevance with an LLM layer, and exposes review/dismiss/escalate-to-NPA workflows through a FastAPI backend and React SPA behind an nginx edge. Tech stack: **Python, FastAPI, PostgreSQL, SQLAlchemy, Alembic, RabbitMQ, LangChain (Claude), React, TypeScript, Vite, Docker, nginx**.
- **[development-agent](https://github.com/semwett0301/development-agent)** - AI-driven autonomous development agent designed to automate core stages of the software development lifecycle directly inside GitHub. The system operates as a GitHub-native agent that reads Issues, plans implementation steps, modifies code, creates and updates Pull Requests, triggers CI pipelines, and iteratively refines changes based on test results and automated reviews. The agent simulates both a developer and a reviewer, enabling closed-loop SDLC automation using GitHub Issues, Pull Requests, Webhooks, and Actions only. Built for extensibility and research into coding agents, review strategies, and CI-aware reasoning, with containerized execution and secure GitHub App authentication. Tech stack: **Python, GitHub App API, GitHub Webhooks, GitHub Actions, LangChain, LLM APIs (OpenAI/Claude-compatible), Docker, YAML, JWT, REST APIs**.
- **[rcruit-flow](https://github.com/semwett0301/rcruit-flow)** - AI-powered recruitment automation platform in a full-stack monorepo: backend and frontend system that processes CVs, extracts structured data, and generates personalised recruitment emails using GPT models. Includes a NestJS API (CV parsing, email generation, user management), React frontend (forms, multi-language UI, analytics), shared DTO packages, and Turborepo-based orchestration. Designed for scalable document processing, smooth candidate workflow management, and production-ready cloud deployment on AWS. Tech stack: **TypeScript, NestJS, PostgreSQL, TypeORM, OpenAI API, AWS S3/MinIO, React 18, Vite, Tailwind CSS, Styled Components, React Query, React Hook Form, Zod, i18next, Radix UI, Turborepo, pnpm, Docker**.
- **[rcruit-flow-landing](https://github.com/semwett0301/rcruit-flow-landing)** - **Lovable-generated** marketing landing page: a modern single-page website for presenting the Rcruit Flow product. It features a responsive UI, structured product sections, built-in interaction forms, animations, SEO optimisation, and a component-based layout. The project is designed for quick customisation, easy content updates, and seamless cloud deployment. Tech stack: **TypeScript, React, Next.js, Tailwind CSS**.
