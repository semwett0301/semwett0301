...
\section{BACKEND EXPERIENCE (≈ 4 YEARS)}
\begin{enumerate}[leftmargin=1em, itemsep=0.01em, labelsep=0.2em, topsep=0em]
  ...
  \item \normalsize{\textbf{\color{darkblue} Full Stack Developer (Backend-focused)} \hfill \textit{Nov 2023 -- Apr 2024}} \\ [0.5mm]
  \small{\textit{\textbf{Tune IT} — EdTech solutions}} \\ [1mm]
  \small{Developed and maintained the Skillfactory educational platform and the Polytech introduction system, focusing on backend scalability and modularity.} \\ [1mm]
  {\small \textbf{Tech stack:} Spring Cloud, Java, Kotlin, PostgreSQL, Redis, React, TypeScript, RTK Query, Docker} 
  {\small
    \vspace{-0.5mm}
    \begin{itemize}[leftmargin=1.2em, itemsep=0.1em, topsep=0pt, partopsep=0pt]
      \item Resolved 30+ issues, improving system stability.
      \item Reduced design-to-development cycle by 25\% with improved backend APIs.
      \item Cut service latency by 13\% through modularization with Spring Cloud.
    \end{itemize}
  }

  \item \normalsize{\textbf{\color{darkblue} Full Stack Developer (Backend-focused)} \hfill \textit{Mar 2023 -- Nov 2023}} \\ [0.5mm]
  \small{\textit{\textbf{MagicGophers} — Social apps for VK (largest social network in Russia)}} \\ [1mm]
  \small{Built backend services and APIs for VK mini-apps, ensuring performance, scalability, and data consistency.} \\ [1mm]
  {\small \textbf{Tech stack:} NestJS, PostgreSQL, Redis, React, VK API, Docker} 
  {\small
    \vspace{-0.5mm}
    \begin{itemize}[leftmargin=1.2em, itemsep=0.1em, topsep=0pt, partopsep=0pt]
      \item Delivered apps adopted by 10,000+ users.
